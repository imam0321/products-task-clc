  ...
  return (
    <div className="border rounded-lg p-2 hover:shadow-lg transition relative">
      <Link href={`/products/${product.id}`} className="block">
        {product.discount_amount && <div className="absolute top-4 right-4 bg-red-500 text-white font-semibold rounded-full p-2 text-center text-xs leading-tight md:text-sm">
